...
function setActiveSection() {
  ...
  if((scrollPosition >= 7700)&&(scrollPosition <=32000) ){
...
window.addEventListener('scroll', setActiveSection);
  ...
  var showPosition = 9100 // Scroll position to show the announcement
  var hidePosition = 9600; // Scroll position to hide/remove the announcement

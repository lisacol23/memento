...
function setActiveSection() {
  ...
  if((scrollPosition >= 7400)&&(scrollPosition <=31500) ){
...
window.addEventListener('scroll', setActiveSection);
  ...
  var showPosition = 7200 // Scroll position to show the announcement
  var hidePosition = 7900; // Scroll position to hide/remove the announcement
